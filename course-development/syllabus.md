...
- By Thursday each week: the next week's flipped activity is posted on CourseWorks.
...
The student is responsible for all parts of the final submission.

Example: "*I used ChatGPT to brainstorm possible visualizations and to debug an R error. I checked the code output against the dataset, revised the plot labels to make it easier to read, and wrote the interpretation without AI-generated text.*"

AI-generated claims, code, and citations can be wrong. Students are responsible for checking them.

Undisclosed meaningful use of AI on submitted work is a violation of academic integrity and will be reported if detected. Students should ask the instructional team before submitting work if they are unsure whether a particular use of AI needs to be acknowledged.

## Other Policies

### CourseWorks, Email, And Questions

Students are responsible for staying informed about course expectations, deadlines, and announcements. Please check CourseWorks at least once each day during the semester. Important time-sensitive announcements will also be sent by email, so students are expected to monitor their Columbia email regularly.

Students are encouraged to ask questions openly on the CourseWorks discussion board when the question could be useful to other students. This includes questions about course logistics, concepts, readings, flipped activities, projects, quizzes, and statistical software. Posting questions publicly helps the instructional team answer once in a place where everyone can benefit from the response. Direct email should be reserved for matters that require a private conversation, such as personal circumstances, accommodations, illness, grading concerns, or other sensitive issues.

### Academic Integrity

Academic honesty is expected of all students at all times. Students are responsible for understanding and abiding by the academic integrity standards of their school, including Columbia College and SEAS's [Academic Integrity](https://www.cc-seas.columbia.edu/academic-integrity) statements, General Studies' [Honor Pledge](https://bulletin.columbia.edu/general-studies/academic-policies/honor-pledge/), and Barnard's [Honor System](https://barnard.edu/student-conduct-pilot), as applicable. Ignorance of these policies is not a defense in academic integrity proceedings.

All submitted work must be the student's own work, or the work of the student's approved project group when group work is explicitly assigned. Students must properly acknowledge the ideas, sources, tools, and assistance that shaped their work. Cheating, plagiarism, unauthorized collaboration, fabrication of data or sources, and misrepresentation of another person's or tool's work as one's own are violations of academic integrity.

### Late Registration And Catch-Up

Students who register late should contact the course staff as soon as possible. The first three weeks are designed to make late entry manageable. Early preparation activities may be completed late for completion credit during the catch-up window announced on CourseWorks.
